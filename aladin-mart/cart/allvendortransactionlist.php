...
<!DOCTYPE html> 
    ...
    <body>
        ...
        <?php
            ...
            echo'</br>
                    <a href="../admin/adminhomepage.php?loggedin=successful">
            ...
            if (isset($_SESSION['user_type']) && ($_SESSION['user_type'] == "admin") && isset($_GET['selectionid'])) {

                $selectionid = (int) $_GET['selectionid'];
                $transactions = getAllTransaction($pdo, $selectionid);
