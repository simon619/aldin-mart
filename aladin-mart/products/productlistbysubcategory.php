...
<!DOCTYPE html> 
        ...
        <?php
            ...
            function showProductTest($pdo, $subcatid) {
                ...
                while ($result = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    $subcatid .
                    "'><a href='productdetail.php?product_id=" . $productid . "&vendor_id=" . $vendorid . "'>" . htmlspecialchars($producttitle) . 
                    "</a></li>";
            ...
            function showSubCategoryTest($pdo, $catid) {
                ...
                while ($result = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    $catid . "'><a href='productlistbysubcategory.php?subcategory_id=" . $subcategoryid . "' class='dropdown-toggle' data-toggle='dropdown'>" . 
            ...
            function showCategoryTest($pdo) {
                ...
                while ($result = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    $html .= "<li class= '$parentDepth0 " . 'parent-' . 0 ."'><a href='productlistbycategory.php?category_id=" . $categoryid . "' class='dropdown-toggle' data-toggle='dropdown'>" . 
    ...
    <div class="container">
        ...
        $products = getAllProductsBySubcategory($pdo, $subcategoryid);
        $subcategoryname = $products[0]['sub_category_name'];

        if ($products) {

            if (isset($_SESSION['user_type']) && ($_SESSION['user_type'] == "customer") && isset($_SESSION['user_district_id'])) {

                showAllProductsBySubcategory($products, $subcategoryname);
